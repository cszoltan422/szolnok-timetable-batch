...
import org.zenbot.szolnok.timetable.backend.batch.news.batch.step.news.listener.SaveNewsJobExecutionListener
...
class NewsBatchConfiguration(
    private val jobBuilderFactory: JobBuilderFactory,
    private val listener: SaveNewsJobExecutionListener,
